...
def mergeAliases(entries): 

    w_log = UnicodeWriter(open(os.path.join(dataPath, 'idm', 'idm_log.csv'), 'wb'), encoding='utf-8')
    writer = UnicodeWriter(open(os.path.join(dataPath, 'idm', 'idm_map.csv'), 'wb'), encoding='utf-8')
    w_maybe = UnicodeWriter(open(os.path.join(dataPath, 'idm', 'idm_maybe.csv'), 'wb'), encoding='utf-8')
    ...
    # uid,login,name,user_type,location,email
